...
<body>
  <div class="general">
    ...
    <div class="main" style="background-color: black">
      ...
      <form id="divSplit" class="form" method="post" action="{{ route('toCanteen') }}">
        ...
        <img type="submit" class="image" src="{{ asset('assets/kantin/KantinT.jpeg') }}" alt="Kantin T" />
      </form>
    </div>
  </div>
  ...
  <section class="mobile">
    ...
    <section>
      <!-- Carousel wrapper -->
      <div id="carouselBasicExample" class="border border-4 carousel slide carousel-fade ms-5 me-5" data-bs-ride="carousel" data-bs-touch="true">
        <!-- Indicators -->
